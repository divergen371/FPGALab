...
module tb_mux4;
    ...
    initial begin
        ...
        sel = 2'b00; #10; // y = d0(0) になるはず
        sel = 2'b01; #10; // y = d1(1) になるはず
        sel = 2'b10; #10; // y = d2(0) になるはず
        sel = 2'b11; #10; // y = d3(1) になるはず

        // 入力データパターン2: d3=0, d2=1, d1=0, d0=1
        d0 = 1; d1 = 0; d2 = 1; d3 = 0;
        $display("\n--- Pattern 2: {d3, d2, d1, d0} = 0101 ---");
        sel = 2'b00; #10; // y = d0(1) になるはず
        sel = 2'b01; #10; // y = d1(0) になるはず
        sel = 2'b10; #10; // y = d2(1) になるはず
        sel = 2'b11; #10; // y = d3(0) になるはず
